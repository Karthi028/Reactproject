const Cart = ({items,setitems,setcart}) => {
 ...
 const cartitems = items.map((item)=>{
  ...
  return (
    ...
    <div id="cart" style={{position:"absolute",top:'10%',left:'10%',width:'80%',height:'auto',display:'none',boxShadow:'1px 1px 5px grey',borderRadius:'10px',background:'white',flexDirection:'column',gap:'30px',overflow:'auto',marginBottom:'10px'}}>
